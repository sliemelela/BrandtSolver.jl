...
# ==============================================================================
# 0. TEST HELPERS (The "Bridge")
# ==============================================================================
# Since BrandtSolver is now a pure-math engine, we define these helpers in the
# test suite to extract raw matrices from FinancialMarketSimulation.jl
